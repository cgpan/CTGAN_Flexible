...
class DataSampler(object):
    ...
    def sample_condvec(self, batch, user_specified_col_index=None):
        ...
        # PAN：note the user_specified_col_index should be a list of name index in the discrete_columns
        # by default, ctgan function will convert the user_specified_col into index, check ctgan.py
        if user_specified_col_index is not None:
            discrete_column_id = np.random.choice(user_specified_col_index, batch)
        else:
